export const quiz = {
    "quizTitle": "Recycling Knowledge Quiz",
    "quizSynopsis": "Test your knowledge about recycling practices in King County.",
    "nrOfQuestions": "11",
    "questions": [
      {
        "question": "Which of the following items should NOT be put in King County's recycling bins?",
        "questionType": "text",
      ...
      },
      {
        ...
        "answers": [
          ...
          "Take them to a household hazardous waste disposal site",
      ...
      },
      {
        ...
        "answerSelectionType": "single",
        "answers": [
          "Force them into the recycle bin",
          "Place them on top of the recycle bin",
          "Stack them next to the bin",
          "Leave them wherever you can find a spot"
        ],
        "correctAnswer": "3",
        "messageForCorrectAnswer": "Correct answer. Good job.",
        "messageForIncorrectAnswer": "Incorrect answer. Please try again.",
      ...
      },
      {
        ...
        "answerSelectionType": "single",
        "answers": [
          "Plastic bags, saran wrap, holiday lights",
          "Boxes and cartons",
      ...
      },
      {
        ...
        "answerSelectionType": "single",
        "answers": [
          "They can be recycled on the water bottle",
          "They can recycled on their own",
          "They should be thrown away in trash"
        ],
        "correctAnswer": "1",
        "messageForCorrectAnswer": "Correct answer. Good job.",
        "messageForIncorrectAnswer": "Incorrect answer. Please try again.",
      ...
      },
      {
        ...
        "answerSelectionType": "single",
        "answers": [
          "Throw it in the recycling bin anyway",
          "Assume it’s not recyclable",
          "Ask your neighbor",
          "Check your city/county’s recycling guidelines"
        ],
        "correctAnswer": "4",
        "messageForCorrectAnswer": "Correct answer. Good job.",
        "messageForIncorrectAnswer": "Incorrect answer. Please try again.",
